...
vim.api.nvim_set_keymap("n","<leader>t", "<cmd>lua my_floating_terminal()<CR>", {noremap = true})


-- New (vertical) terminal
local hori_term = Terminal:new({
	--cmd = "top", -- Options are: "float", 
	direction = "horizontal", -- Options are: horizontal, vertical, and float
...
vim.api.nvim_set_keymap("n","<leader>v", "<cmd>lua hori()<cr>", {noremap = true})
